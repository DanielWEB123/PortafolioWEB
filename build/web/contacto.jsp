...
<html>
    ...
    <body background="images/contacto.jpg" style="background-color:#000050 background-position: center; background-size: cover; background-repeat:no-repeat; max-width: 100%; max-height: 100%;">
        ...
        <table border="0" style="width: 100%" align="center">
            ...
            <tr>
                <td valign="top">
                    <h2 style="color:orange" >&nbsp;&nbsp;CONTACTO</h2> <br>

                    <table border="1" style="width: 95%" align="center">
                        <tr>
                            <td style="color:white;"><h5>SUSCRITOS</h5></td>
                        </tr>
                ...
                <td valign="top"> 
                    ...
                    <form action="formulario.jsp">
                        ...
                        <table border="1" style="width: 80%" align="center">
                            ...
                            <tr>
                                <td colspan="3" style="color:white; text-align: center"><br><h5>FORMULARIO</h5><br></td>
                                <td></td>
                            </tr>    
                            ...
                            <tr>
                                <td style="width: 26px">&nbsp;</td>
                                <td colspan="3" style="color:white">Si te suscribes, podrás recibir manuales, consejos y novedades sobre el jundo de la Informática, sobre todo de la Programación<br><br></td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
